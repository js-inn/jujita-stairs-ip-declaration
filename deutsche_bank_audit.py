...
def integrate_deutsche_bank_core():
    ...
    # Deutsche Bank Frankfurt Core Node Parameters
    db_nodes = [
        ("10839477 Canada Inc. (Deutsche Bank Frankfurt Core)", "DEUTDEFF-CORE-NODE", "TARGET2 RTGS / SWIFT DEUTDEFF SETTLEMENT", 0.0, 0.0, "Core Node Active / Frankfurt TARGET2 Liquidity Bound")
    ]
    
    timestamp = datetime.now().isoformat()
    
    for entity, ident, atyp, cad_bal, usd_bal, note in db_nodes:
    ...
    print(f"\n=======================================================================")
    print(f"[*] DEUTSCHE BANK FRANKFURT CORE — ANCHORED TO {ROOT_PARENT}")
    print(f"=======================================================================\n")
