...
class BaseResolvedConfigurationVariable {
    ...
    async getUrl() {
        ...
        try {
            ...
            throw new HardhatError(HardhatError.ERRORS.CORE.GENERAL.INVALID_CONFIG_VARIABLE_URL, { configVariable: this._getDescription() });
        }
    }
    async getBigInt() {
        const value = await this.get();
        try {
            ...
            throw new HardhatError(HardhatError.ERRORS.CORE.GENERAL.INVALID_CONFIG_VARIABLE_BIGINT, { configVariable: this._getDescription() });
        }
    }
    async getHexString() {
        const value = await this.get();
        try {
            ...
            throw new HardhatError(HardhatError.ERRORS.CORE.GENERAL.INVALID_CONFIG_VARIABLE_HEX_STRING, { configVariable: this._getDescription() });
        }
    }
}
