import type { EdrNetworkAccountConfig, EdrNetworkAccountsConfig, ChainDescriptorsConfig, EdrNetworkConfig, EdrNetworkForkingConfig, EdrNetworkMempoolConfig, EdrNetworkMiningConfig } from "../../../../../types/config.js";
import type { ChainType } from "../../../../../types/network.js";
import type { GasMeasurement } from "../../../gas-analytics/types.js";
import type { IntervalRange, ChainOverride, ForkConfig, GasReport } from "@nomicfoundation/edr";
import { GasEstimationMode, MineOrdering, OpHardfork, SpecId } from "@nomicfoundation/edr";
...
export declare function hardhatGasEstimationModeToEdrGasEstimationMode(gasEstimationMode: EdrNetworkConfig["gasEstimationMode"]): GasEstimationMode;
 ...
 */
export declare function resolveDefaultTransactionGasLimit(params: {
    chainType: ChainType;
    hardfork: string;
