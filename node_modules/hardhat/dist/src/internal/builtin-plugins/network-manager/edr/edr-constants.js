...
export const DEFAULT_EDR_NETWORK_BLOCK_GAS_LIMIT = 60000000n;
// EIP-7825 per-transaction gas cap, enforced from L1's Osaka hardfork onwards
export const EIP_7825_TRANSACTION_GAS_CAP = 16777216n;
export const EDR_NETWORK_MNEMONIC = "test test test test test test test test test test test junk";
export const DEFAULT_EDR_NETWORK_BALANCE = 10000000000000000000000n;
export const DEFAULT_EDR_NETWORK_HD_ACCOUNTS_CONFIG_PARAMS = {
    ...DEFAULT_HD_ACCOUNTS_CONFIG_PARAMS,
    mnemonic: EDR_NETWORK_MNEMONIC,
    accountsBalance: DEFAULT_EDR_NETWORK_BALANCE,
};
export async function isDefaultEdrNetworkHDAccountsConfig(accounts) {
...
export const EDR_NETWORK_DEFAULT_PRIVATE_KEYS = [
...
//# sourceMappingURL=edr-constants.js.map