...
import { InternalCallOutOfGasError, isInternalCallOutOfGasErrorData, InvalidArgumentsError, ProviderError, UnknownError, } from "../provider-errors.js";
...
import { hardhatMiningIntervalToEdrMiningInterval, hardhatMempoolOrderToEdrMineOrdering, hardhatHardforkToEdrSpecId, hardhatForkingConfigToEdrForkConfig, hardhatGasEstimationModeToEdrGasEstimationMode, resolveDefaultTransactionGasLimit, } from "./utils/convert-to-edr.js";
...
export class EdrProvider extends BaseProvider {
    ...
    static async create({ chainDescriptors, networkConfig, loggerConfig = { enabled: false }, contractDecoder, jsonRpcRequestWrapper, coverageConfig, gasReportConfig, includeCallTraces, verbosity, connectionId, networkName, }) {
        ...
        try {
            ...
            edrProvider = new EdrProvider(provider, providerConfig.defaultTransactionGasLimit, 
            // EDR only enforces a block gas limit when it was given a mining one,
            // which `blockGasLimit: false` omits
            providerConfig.mining.blockGasLimit !== undefined, traceOutput, jsonRpcRequestWrapper);
     ...
     * `EdrProvider`.
     */
    constructor(provider, defaultTransactionGasLimit, blockGasLimitEnforced, traceOutput, jsonRpcRequestWrapper) {
        super();
...
export async function getProviderConfig(networkConfig, coverageConfig, gasReportConfig, chainDescriptors, includeCallTraces) {
    ...
    return {
        ...
        defaultTransactionGasLimit,
        gasEstimationMode: hardhatGasEstimationModeToEdrGasEstimationMode(networkConfig.gasEstimationMode),
