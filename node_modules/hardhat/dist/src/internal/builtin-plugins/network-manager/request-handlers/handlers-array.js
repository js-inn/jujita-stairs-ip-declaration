...
export async function createHandlersArray(networkConnection) {
    ...
    if (networkConfig.gas === undefined || networkConfig.gas === "auto") {
        ...
        const fallbackGas = "defaultTransactionGasLimit" in provider &&
        ...
        const isBlockGasLimitEnforced = () => !("isBlockGasLimitEnforced" in provider) ||
            provider.isBlockGasLimitEnforced !== false;
        requestHandlers.push(new AutomaticGasHandler(networkConnection.provider, networkConfig.gasMultiplier, fallbackGas, isBlockGasLimitEnforced));
    }
    else {
