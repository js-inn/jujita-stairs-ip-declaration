    ...
    async #resolveRequest(jsonRpcRequest) {
        ...
        if (jsonRpcRequest.method === "eth_sign") {
            if (params.length > 0) {
                ...
                if (address !== undefined) {
                    ...
                    return this.#createJsonRpcResponse(jsonRpcRequest.id, microEthSigner.eip191Signer.sign(data, privateKey, EXTRA_ENTROPY));
                }
            }
        }
        ...
        if (jsonRpcRequest.method === "eth_signTypedData_v4") {
            ...
            if (privateKey !== null) {
                ...
                return this.#createJsonRpcResponse(jsonRpcRequest.id, microEthSigner.signTyped(typedMessage, privateKey, EXTRA_ENTROPY));
            }
        }
        return null;
    }
