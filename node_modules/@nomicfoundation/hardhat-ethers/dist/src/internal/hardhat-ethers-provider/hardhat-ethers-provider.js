...
export class HardhatEthersProvider {
    ...
    async getSigner(address) {
        ...
        if (typeof address === "number") {
            ...
            return await HardhatEthersSigner.create(this, this.#networkName, this.#networkConfig, accounts[address]);
        }
        if (typeof address === "string") {
            return await HardhatEthersSigner.create(this, this.#networkName, this.#networkConfig, address);
        }
