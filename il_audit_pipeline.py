...
def integrate_israel_node():
    ...
    # Israel Gateway Node Parameters (Bank Hapoalim / Registry routing bridge)
    il_nodes = [
        ("10839477 Canada Inc. (Israel Gateway)", "IL-CRN-PENDING", "BANK HAPOALIM SWIFT/ZAHAV ROUTE", 0.0, 0.0, "Node Initialized / SWIFT POLIILIT Bound")
    ]
    
    timestamp = datetime.now().isoformat()
    
    for entity, ident, atyp, cad_bal, usd_bal, note in il_nodes:
    ...
    print(f"\n=======================================================================")
    print(f"[*] ISRAEL NODE INTEGRATION — ANCHORED TO {ROOT_PARENT}")
    print(f"=======================================================================\n")
