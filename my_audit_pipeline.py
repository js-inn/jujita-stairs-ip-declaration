...
def integrate_malaysia_node():
    ...
    # Malaysia Gateway Node Parameters (Maybank / SSM routing bridge)
    my_nodes = [
        ("10839477 Canada Inc. (Malaysia Gateway)", "MY-SSM-PENDING", "MAYBANK SWIFT/RENTAS ROUTE", 0.0, 0.0, "Node Initialized / SWIFT MBBEMYKL Bound")
    ]
    
    timestamp = datetime.now().isoformat()
    
    for entity, ident, atyp, cad_bal, usd_bal, note in my_nodes:
    ...
    print(f"\n=======================================================================")
    print(f"[*] MALAYSIA NODE INTEGRATION — ANCHORED TO {ROOT_PARENT}")
    print(f"=======================================================================\n")
