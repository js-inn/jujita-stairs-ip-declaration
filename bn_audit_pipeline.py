...
def integrate_brunei_node():
    ...
    # Brunei Gateway Node Parameters (Baiduri Bank / ROCBN routing bridge)
    bn_nodes = [
        ("10839477 Canada Inc. (Brunei Gateway)", "BN-ROCBN-PENDING", "BAIDURI BANK SWIFT/RTGS ROUTE", 0.0, 0.0, "Node Initialized / SWIFT BAIDBBNB Bound")
    ]
    
    timestamp = datetime.now().isoformat()
    
    for entity, ident, atyp, cad_bal, usd_bal, note in bn_nodes:
    ...
    print(f"\n=======================================================================")
    print(f"[*] BRUNEI NODE INTEGRATION — ANCHORED TO {ROOT_PARENT}")
    print(f"=======================================================================\n")
