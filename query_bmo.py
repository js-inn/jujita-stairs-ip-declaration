...
KEYWORDS = ["bmo", "bank of montreal", "montreal"]

def search_bmo_records():
    print(f"\n==========================================")
    print(" SCANNING FOR BMO REFERENCES")
    print("==========================================")
    ...
    if found_matches == 0:
        print("No explicit text matches found for BMO in the compliance directory.")
    else:
        print(f"==========================================")
